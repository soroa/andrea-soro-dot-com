...
> The **total** shown on the site is the sum of all categories below.
...
Each row becomes a card in the Workshop History gallery on the site.
...
<!-- Example row:
| 1  | Sensual Bachata Intensive | Milan      | 2024 |
| 2  | Zouk Flow                 | Barcelona  | 2023 |
-->
